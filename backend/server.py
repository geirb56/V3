...
# Import local analysis engine (NO LLM dependencies)
...
def calculate_training_zones(vma_kmh: float, language: str = "fr") -> dict:
...
async def get_vma_estimate(user_id: str = "default", language: str = "fr"):
...
def calculate_recovery_score(workouts: list, language: str = "fr") -> dict:
